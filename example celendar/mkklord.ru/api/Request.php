...
class Request extends Simpla
{
	...
	*/
     ...
     * @return mixed
     */
    public function safe_get(string $name, ?string $type = null)
    {
        $value = $this->get($name, $type);
     ...
     * @return mixed
     */
    public function safe_post(string $name, ?string $type = null)
    {
        $value = $this->post($name, $type);
	...
	*/
    public function url( $params = [] ): string
    {
        ...
        $url['query'] = $query_is_empty ? null: http_build_query( $query );
