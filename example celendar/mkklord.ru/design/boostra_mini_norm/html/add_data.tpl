...
{/if}
    <script src="design/{$settings->theme}/js/additional_data.app.js?v=1.71" type="text/javascript"></script>


	<script src="design/{$settings->theme}/js/files_data.app.js?v=1.58" type="text/javascript"></script>
	...
	<div>
		<div class="box">
			<hgroup>
				...
				<h5>В вашей анкете не хватает некоторых данных.</h5>
			</hgroup>
				...
				<div id="steps">
					...
					<fieldset id="personal_data" style="display: block;;">
                        ...
                        <div class="clearfix">
    						...
    						<label>
    							<input type="text" name="patronymic" value="{$user->patronymic}" placeholder=""/>
                                <span class="floating-label">Отчество (Необязательно)</span>
    						</label>
                            {/if}
                        ...
                        <div class="clearfix">
                            ...
                            <label class="">
    							<input type="text" name="birth" value="{$user->birth}" placeholder="" required=""/>
                        ...
                        <div class="clearfix">
                            ...
                            <label>
    							<input type="text" name="passport_serial" value="{$user->passport_serial}" placeholder="" required=""/>
                            ...
                            <label>
    							<input type="text" name="passport_date" value="{$user->passport_date}" placeholder="" required=""/>
    						...
    						<label>
    							<input type="text" name="subdivision_code" value="{$user->subdivision_code}" placeholder="" required=""/>
						...
						<div class="register">
                            ...
                            <label class="{if $error=='empty_Regregion'}error{/if} region--label" id="regregion-label">
								<div class="select">
                                    <select id="Regregion" name="Regregion" required>
                                        ...
                                        <option value="{$region->short_name}">{$region->name}</option>
                                        {/foreach}
                                    </select>
                                </div>
							...
							<label class="{if $user->Regcity}readonly{/if}" id="regcity-label">
								<input type="text" name="Regcity" value="" placeholder="" required="" rel="city" aria-required="true" data-selected = 'false'/>
                                <span class="floating-label">Город</span>
                                {if $error=='empty_Regcity'}<span class="error">Укажите город в котором Вы прописаны</span>{/if}
							</label>

							<label class="{if $user->Regstreet}readonly{/if}" id="regstreet-label">
								<input type="text" name="Regstreet" value="" placeholder="" rel="street" data-selected = 'false'/>
							...
							<label class="{if $user->Reghousing}readonly{/if}" id="reghousing-label">
								<input type="text" name="Reghousing" value="" placeholder=""  rel="house" aria-required="true" data-selected = 'false'/>
							...
							<label class="{if $user->Regbuilding}readonly{/if} ">
								<input type="text" name="Regbuilding" value="" placeholder="" class="adding sup" rel="building" aria-required="true" data-selected = 'false'/>
							    <span class="floating-label">Строение</span>
                            </label>

							<label class="{if $user->Regroom}readonly{/if} ">
								<input type="text" name="Regroom" value="" placeholder="" class="adding sup" rel="flat" aria-required="true" data-selected = 'false'/>
						...
						<div class="living" id="living_block">
							...
							<label class="{if $user->Faktcity}readonly{/if}" id="faktcity-label">
								<input type="text" name="Faktcity" value="" placeholder="" required="" rel="city" data-selected = 'false'/>
                                <span class="floating-label">Город</span>
                                {if $error=='empty_Faktcity'}<span class="error">Укажите город фактического проживания</span>{/if}
							</label>

                            <label class="{if $user->Faktstreet}readonly{/if}" id="faktstreet-label">
								<input type="text" name="Faktstreet" value="" placeholder="" rel="street" data-selected = 'false'/>
                                <span class="floating-label">Улица</span>
                                {if $error=='empty_Faktstreet'}<span class="error">Укажите улицу фактического проживания</span>{/if}
							</label>

							<label class="{if $user->Fakthousing}readonly{/if}" id="fakthousing-label">
								<input type="text" name="Fakthousing" value="" placeholder=""  rel="house" data-selected = 'false'/>
                                <span class="floating-label">Дом</span>
							...
							<label class="{if $user->Faktbuilding}readonly{/if}">
								<input type="text" name="Faktbuilding" value="" placeholder="" class="adding sup" rel="building" data-selected = 'false'/>
							    <span class="floating-label">Строение</span>
                            </label>

							<label class="{if $user->Faktroom}readonly{/if}">
								<input type="text" name="Faktroom" value="" placeholder="" class="adding sup" rel="flat" data-selected = 'false'/>
							    <span class="floating-label">Квартира</span>
                            </label>
                        ...
                        <div class="clearfix">
                            ...
                            <label class="readonly {if $error=='empty_contact_person_phone'}error{/if}">
                                <input type="text" class="" name="contact_person_phone" value="" placeholder="" />
					...
					<fieldset id="additional_data" style="display: block;;">
    						...
    						<label id="work_scope_select" {if $other_work_scope_active}style="display:none"{/if}>
    							<div class="select">
                                    <select name="work_scope" {if $other_work_scope_active}disabled="true"{/if}>
                                        ...
                                        <option value="Самозанятый" {if $user->work_scope == 'Самозанятый'}selected=""{/if}>Самозанятый</option>
                        ...
                        <div class="clearfix">
    						...
    						<label class="half js-pensioner-hidden {if $error=='empty_workdirector_name'}error{/if}" style="display:none">
                ...
                <div id="file_form">
                    ...
                    <fieldset class="passport4-file file-block">
                        ...
                        <div class="file-field" {if $passport4_file}style="display:none"{/if}>
                            <label class="file-label">
                                <div class="file-label-image cvc-warning">
