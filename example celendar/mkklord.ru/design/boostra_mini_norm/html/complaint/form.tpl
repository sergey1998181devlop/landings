<form id="complaint" class="complaint-container">
    <div class="btns">
        ...
        <div>
            ...
            <p>Мы обещаем, что Ваша жалоба попадет на контроль к руководству компании и будет оперативно решена с соблюдением всех прав заемщика, отраженных в федеральных законах, стандартах и предписаниях Банка России и СРО, а также иных нормативных документов.</p>
            <p>О результатах рассмотрения Вашего обращения Вы будете уведомлены путем направления ответа на Вашу электронную почту, с которой Вы направляли обращение.</p>
        </div>
    </div>
    ...
    <div class="content-complaint">
        ...
        <div class="complaint-content-grid">
            ...
            <div class="input-control">
                <label for="complaint_birth">Дата рождения</label>
                <input id="complaint_birth"
                       name="complaint_birth"
                       type="date"
            ...
            <div class="input-control">
                ...
                <select id="complaint_topic"
                        name="complaint_topic"
                        class="complaint_topic">
