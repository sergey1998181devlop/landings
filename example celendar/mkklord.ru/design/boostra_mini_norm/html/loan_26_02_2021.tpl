    ...
    <div id="accept" class="white-popup mfp-hide">
        ...
        <div>
            <label>
                ...
                <a href="{$config->root_url}/files/docs/soglashenie-o-regulyarnyh-rekurrentnyh-platezhah-mkk-ooo-bustra.pdf" target="_blank">"Соглашением о регулярных (рекуррентных) платежах МКК ООО «БУСТРА»"</a>
            </label>
        </div>
        ...
        <div>
            <label>
                ...
                <a href="{$config->root_url}/files/docs/polozhenie-o-dopolnitelnyh-finansovyh-uslugah--mkk--ooo-bustra-sms-informirovanie-.pdf" target="_blank">"Положением о дополнительных финансовых услугах МКК ООО «Бустра» «СМС-ИНФОРМИРОВАНИЕ»"</a>
            </label>
        </div>        
