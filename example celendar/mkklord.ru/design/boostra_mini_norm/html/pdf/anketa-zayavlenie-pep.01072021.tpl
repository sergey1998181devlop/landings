<table width="530" cellspacing="0" cellpadding="3" border="1">
        ...
        <tr>
            <td >&nbsp;</td>
            <td colspan="4" >
                <strong>5. ФИНАНСОВЫЕ ПОКАЗАТЕЛИ</strong>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="2" width="45%">
                Сведения о результатах проверки наличия (отсутствия) в отношении клиента информации 
        ...
        <tr>
            <td colspan="5" >
                <strong>7. СВЕДЕНИЯ О ПРЕДСТАВИТЕЛЕ КЛИЕНТА</strong>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="5" >
                <strong>8. СВЕДЕНИЯ О БЕНЕФИЦИАРНОМ ВЛАДЕЛЬЦЕ</strong>
            </td>
        </tr>
        ...
        <tr>
            <td >&nbsp;</td>
            <td colspan="4" >
                <strong>9. СВЕДЕНИЯ ВЫГОДОПРИОБРЕТАТЕЛЕ</strong>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="4" width="90%">
                * Сведения, предусмотренные пунктами 6.3.-6.6. настоящего подпункта, заполняются в отношении Клиентов
                    с высокой степенью (уровнем) риска клиента.
                **Сведения, указанные в п.п.7.1.-7.9. указываются, если обратился представитель клиента
                *** Сведения, указанные в п.п. 8.1-8.9 указываются при выявлении Бенефициарного владельца
                **** Сведения, указанные в п.п.9.1-9.9. указываются при выявлении Выгодоприобретателя
            </td>
        </tr>
