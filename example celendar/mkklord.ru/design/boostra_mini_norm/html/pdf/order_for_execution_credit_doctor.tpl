...
{if $organization->id == 11}
    {assign var="org_name" value="ООО МКК «Финлаб»"}
...
<table cellpadding="5" cellspacing="0" border="0" width="100%" style="line-height: 1.5">
    ...
    <tr>
        <td>
            ...
            Назначение платежа: оплата по договору на приобретение ПО «Финансовый доктор» СВФСИС Nº20156 за  {$lastname|escape} {$firstname|escape} {$patronymic|escape}.<br/>
            Данную сумму прошу перечислить, в срок не позднее одного рабочего дня с момента подписания настоящего поручения.<br/>
            Я, подтверждаю, что согласен со стоимостью приобретаемой услуги и ознакомлен и согласен с Публичной офертой на оказание платных услуг сервиса, размещенной на сайте  https://finansdoctor.ru/.
        </td>
    </tr>
    <tr>
