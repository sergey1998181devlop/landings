			...
			<form method="post" id="neworder" action="/neworder"> 
				<div id="steps">
					...
					<fieldset>
						...
						<label class="big">
							<input type="text" name="bplace" placeholder="Место рождения" required=""/>
						</label>
					...
					<fieldset>
						<div class="register">
							...
							<label>
								<input type="text" name="Regstreet" placeholder="Улица" required="" rel="street"/>
							</label>
							<label>
						...
						<div class="living">
							...
							<label>
								<input type="text" name="Faktstreet" placeholder="Улица" required="" rel="street"/>
							</label>
							<label>
