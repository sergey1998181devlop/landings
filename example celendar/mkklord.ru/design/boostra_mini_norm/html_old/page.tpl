		...
		<div class="box">
			...
			<div id="docs">
				...
				<ul>
					...
					<li><a href="/files/uploads/rekvisity_2018.pdf" target="_blank">Реквизиты Организации</a></li>
			...
			<div id="contacts">
				...
				<div>
					<div>
					ИНН/КПП {$config->org_inn}/{$config->org_kpp}, ОГРН 1146320005226, ОКПО 21290962,
					</div>
					<div>
