		...
		*}
		...
		<section class="contact_info">
			<div class="cont small">
				...
				<div class="text">Микрокредитная компания Общество с ограниченной ответственностью «{$config->org_name}» ИНН/КПП {$config->org_inn}/{$config->org_kpp}, ОГРН  {$config->org_ogrn}, ОКПО 33529201, р/с 40702810229180002011 в филиале «Нижегородский» АО «Альфабанк» г. Нижний Новгород, к/с 30101810200000000824, БИК 042202824 Юридический адрес: {$config->org_legal_address}</div>
			</div>
		</section>
		<!-- End Основная часть -->
