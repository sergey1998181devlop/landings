...
<div class="panel" id="credit_rating_new_user">
    ...
    <div class="flex-auto title-cr">
        ...
        <hr style="display: none;" class="mr-x-10 skip-button-rating" width="1" size="25"/>
        <a onclick="user_cr_app.skip_rating_pay();" style="display: none;" class="text-grey skip-button-rating" href="javascript:void(0);"><small>подать заявку без рейтинга</small></a>
    </div>
    <div id="user_lk_credit_rating_wrapper">
        {include 'credit_rating/credit_rating.tpl'}
    </div>
    <p>Ваш кредитный рейтинг составляет <span id="rating-ball" class="mr-x-10"></span> <a class="text-violet" data-href="#user-credit-rating-cards">Получить рейтинг</a></p>
    <div class="rating_btn_wrapper flex-vertical">
        Персональный кредитный рейтинг – это оценка финансовой надёжности заёмщика.
        Информация, полученная в результате анализа Ваших данных,
        положительно сказывается на вероятности получения займа.
        <button class="btn-cr btn-violet" data-href="#user-credit-rating-cards">Получить рейтинг</button>
    </div>
    <div class="credit-rating-notice" style="margin-top: 60px; display: none;">
        <div>
        ...
        <div class="user-cr-sms-block">
            ...
            <div id="user-cr-sms-send" style="display: none;">
                <div class="flex-auto">
                    ...
                    <a href="javascript:void(0);" onclick="user_cr_app.send_sms();" class="ml-10"><small>Получить код ещё раз</small></a>
                    <span class="timer-text" style="display: none;"></span>
                </div>
                <p class="text-red" style="display: none;"><small></small></p>
                <button class="btn-cr btn-violet" id="send-pay-cr" onclick="user_cr_app.init_pay();" style="display: none;">Отправить</button>
            </div>
        </div>
    </div>
