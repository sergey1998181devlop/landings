function CreditRatingApp() {
    ...
    app.init_get_rating_button_on_click = function () {
        app.button.click(function() {
            ...
            if (is_developer) {
                console.info('ym reachGoal credit_rating_button');
            } else {
                ym(45594498, 'reachGoal', 'credit_rating_button');
            }
        })
    }
    ...
    app.send_pay_rating = function () {
        ...
        if (card_id == 'other' || !card_id) {
            app.other_payment(app.price, $code_field.val());
        } else {
            app.attach_card_payment(card_id, app.price, $code_field.val());
        }
    ...
    app.attach_card_payment = function(card_id, amount, code_sms){
    ...
    app.other_payment = function(amount, sms_code){
        app.init_spinner();
