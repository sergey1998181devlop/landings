...
<form method=post id=product enctype="multipart/form-data">
	...
	<div id="name">
		...
		<div class="block">
			...
			<li>
				<label class=property>Шаблон<br/><i>По стандарту пусто</i></label>	
				<input name="template" class="simpla_inp" type="text" value="{$page->template|escape}" placeholder="Нестандартный шаблон страницы .tpl"/>
			</li>
		</div>
